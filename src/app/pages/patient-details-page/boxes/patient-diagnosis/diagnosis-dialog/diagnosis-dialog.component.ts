...
export class DiagnosisDialogComponent implements OnInit, OnChanges {
  ...
  private diagnoses : SelectItem[] = [
    ...
    {label:"296.23 Major Depressive Disorder, Single Episode, Severe w/o Psychotic Features", value: DiagnosisTypeEnum.MDDS3},
    {label:"296.24 Major Depressive Disorder, Single Episode, Severe w/Psychotic Features", value: DiagnosisTypeEnum.MDDS4},
    ...
    {label:"296.33 Major Depressive Disorder, Recurrent, Severe w/o Psychotic Features", value: DiagnosisTypeEnum.MDDR3},
    ...
    {label:"296.03 Bipolar I Disorder, Single Manic Episode, Severe w/o psychotic Features", value: DiagnosisTypeEnum.BIPOLARSM3},
    {label:"296.04 Bipolar I Disorder, Single Manic Episode, Severe w/Psychotic Features", value: DiagnosisTypeEnum.BIPOLARSM4},
    ...
    {label:"296.43 Bipolar I Disorder, Most Recent Episode Manic, Severe w/o Psychotic Features", value: DiagnosisTypeEnum.BIPOLARMRM3},
    {label:"296.44 Bipolar I Disorder, Most Recent Episode Manic, Severe w/Psychotic Features", value: DiagnosisTypeEnum.BIPOLARMRM4},
    ...
    {label:"296.53 Bipolar I Disorder, Most Recent Episode Depressed, Severe w/o Psychotic Features", value: DiagnosisTypeEnum.BIPOLARMRD3},
    {label:"296.54 Bipolar I Disorder, Most Recent Episode Depressed, Severe w/Psychotic Features", value: DiagnosisTypeEnum.BIPOLARMRD4},
  ...
  saveDiagnosis() {
    ...
    if(this.diagnosisChanged()) {
      ...
      this.diagnosisService.savePatientDiagnosis(this.patientId, this.diagnosis).subscribe(
        () => {
          this.emitUpdated();
          this.emitHide();
        },
